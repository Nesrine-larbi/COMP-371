...
int main(int argc, char*argv[])
{
    ...
    // Force OpenGL 3.3 Core Profile for modern shader support
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        for (int i=0; i<20; ++i)
        {
            for (int j=0; j<20; ++j)
            {
                ...
                glBindTexture(GL_TEXTURE_2D, cementTextureID); //fix 1
                ...
                glBindTexture(GL_TEXTURE_2D, brickTextureID); //fix 2
...
const char* getTexturedVertexShaderSource() //Todo 1
{
    // For now, you use a string for your shader code, in the assignment, shaders will be stored in .glsl files
    return
                "#version 330 core\n"
...
const char* getTexturedFragmentShaderSource() //Todo 2
{
    return
                "#version 330 core\n"
                "in vec3 vertexColor;"
...
GLuint loadTexture(const char *filename) // Todo 3
{
